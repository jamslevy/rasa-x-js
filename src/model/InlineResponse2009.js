    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('responses')) {
                obj['responses'] = ApiClient.convertToType(data['responses'], [TemplateResponse]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/TemplateResponse>} responses
 */
InlineResponse2009.prototype['responses'] = undefined;
