...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RasaXHttpApi.NlgResponse();
  });
  ...
  describe('NlgResponse', function() {
    it('should create an instance of NlgResponse', function() {
      // uncomment below and update the code to test NlgResponse
      //var instane = new RasaXHttpApi.NlgResponse();
      //expect(instance).to.be.a(RasaXHttpApi.NlgResponse);
    });
