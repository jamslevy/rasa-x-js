...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RasaXHttpApi.Model();
  });
  ...
  describe('Model', function() {
    it('should create an instance of Model', function() {
      ...
      //var instane = new RasaXHttpApi.Model();
      //expect(instance).to.be.a(RasaXHttpApi.Model);
    });
    ...
    it('should have the property trainedAt (base name: "trained_at")', function() {
