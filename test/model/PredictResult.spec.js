...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RasaXHttpApi.PredictResult();
  });
  ...
  describe('PredictResult', function() {
    it('should create an instance of PredictResult', function() {
      // uncomment below and update the code to test PredictResult
      //var instane = new RasaXHttpApi.PredictResult();
      //expect(instance).to.be.a(RasaXHttpApi.PredictResult);
    });
