...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RasaXHttpApi.AuthenticationApi();
  });
  ...
  describe('AuthenticationApi', function() {
    describe('issueJWT', function() {
      it('should call issueJWT successfully', function(done) {
        //uncomment below and update the code to test issueJWT
        //instance.issueJWT(function(error) {
